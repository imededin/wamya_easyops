        ...
        <div className="relative pt-32 pb-10 md:pt-40 md:pb-16">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h1 className="h1 mb-4" data-aos="fade-up">
              Wamya is the best solution for companies looking to optimize their
              operations
            </h1>
            <p
              ...
              data-aos-delay="200"
            >
              Wamya is a user-friendly, one-click solution that simplifies
              project deployment. With just a few clicks, you can easily run
            ...
            >
              <div className="relative pb-9/16">
                <iframe
                  ...
                  src="https://player.vimeo.com/video/800946283?h=804c85bd4b"
                  width="640"
                  height="564"
                  frameborder="0"
